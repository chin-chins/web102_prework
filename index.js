...
function addGamesToPage(games) {
    ...
    for(let i = 0; i < games.length; i++){
        ...
        // about each game
        gameCard.innerHTML = `<img src = "${games[i].img}" class = "game-img" alt = "game cover" /> 
                            <h3>${games[i].name}</h3>
                            ${games[i].description} 
...
function filterUnfundedOnly() {
    ...
    console.log("DEBUG GAMES: ", unfundedGames);
...
const displayStr = `A total of $${totalPledged.toLocaleString()} has been raised for ${totalGames} games.
Currently, ${numUnfunded} ${numUnfunded == 1 ? "game" : "games"} have yet to be fully funded. We need your help to fund these games!`;
